...
const PAIRS: Pair[] = [
  ...
  { what: "job status: enquiry (NEW)", fg: "ink-2", bg: "surface-2", need: 4.5 },
  { what: "job status: quoted (NEW)", fg: "med-ink", bg: "med-bg", need: 4.5 },
  { what: "job status: confirmed (NEW)", fg: "high-ink", bg: "high-bg", need: 4.5 },
  { what: "job status: delivered (NEW)", fg: "accent", bg: "accent-soft", need: 4.5 },
  { what: "job status: invoiced (NEW)", fg: "ok-ink", bg: "ok-bg", need: 4.5 },
  { what: "job status: cancelled (NEW)", fg: "low-ink", bg: "low-bg", need: 4.5 },
  { what: "job date line (NEW)", fg: "ink-2", bg: "surface", need: 4.5 },
  { what: "unresourced job edge (NEW)", fg: "no-ink", bg: "surface", need: 3 },
  { what: "account match row (NEW)", fg: "ink", bg: "surface", need: 4.5 },
  { what: "account match row, hovered (NEW)", fg: "ink", bg: "accent-soft", need: 4.5 },
  { what: "account match meta (NEW)", fg: "ink-3", bg: "surface", need: 4.5 },
  { what: "board column heading (NEW)", fg: "ink", bg: "surface-2", need: 4.5 },
  { what: "board empty-column note (NEW)", fg: "ink-3", bg: "surface-2", need: 4.5 },
  { what: "stage dropdown label (NEW)", fg: "ink-3", bg: "surface", need: 4.5 },
